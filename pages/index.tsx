...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Anggi Juhniawan',", type: 'array-item' },
    ...
    {
      code: '    document.title = `Anggi Juhniawan | Portfolio`;',
      type: 'return',
    },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Anggi <span className={styles.accentText}>Juhniawan</span>
          </h1>
          ...
          <div className={styles.actionLinks}>
            ...
            <a
              href="docs/CV Anggi Juhniawan.pdf"
              target="_blank"
